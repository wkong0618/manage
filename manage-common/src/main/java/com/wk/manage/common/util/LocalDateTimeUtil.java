 ...
 *
 * @author wukong
 * @create 2020-03-22 下午8:32
 */
public class LocalDateTimeUtil {

    public static final String style_yyyyMMddHHmmss = "yyyyMMddHHmmss";
    public static final String style_HH_mm_ss = "HH:mm:ss";
    public static final String style_yyyyMMddHHmmssSSS = "yyyyMMddHHmmssSSS";
    public static final String style_yyyyMMdd_HH_mm_ss = "yyyyMMdd HH:mm:ss";
    public static final String style_yyyy_MM_dd_HHmmssSSS = "yyyy-MM-dd HH:mm:ss:SSS";
    public static final String style_yyyy_MM_dd_HHmmss = "yyyy-MM-dd HH:mm:ss";
